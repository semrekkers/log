...
const (
	...
	Lcolor                                 // colored output (if output is tty)
	LstdFlags     = Ldate | Ltime | Llabel // initial values for the standard logger
)
...
func (l *Logger) ColoredOutput() bool {
	l.mu.Lock()
	defer l.mu.Unlock()
	return l.isTerm && l.flag&Lcolor != 0
}
